...
namespace Soleil.Map
{
    class Somnia1 : MapBase
    {
            ...
            : base(MapName.Somnia1)
        {
            ...
            mcoLeft = new MapChangeObject(new Vector(0, 500), new Vector(30, 260), MapName.Somnia2, new Vector(906, 513), Direction.L, om, bm);
            mcoTop = new MapChangeObject(new Vector(900, 10), new Vector(300, 20), MapName.Somnia4, new Vector(896, 500), Direction.U, om, bm);
        }
    }
}
